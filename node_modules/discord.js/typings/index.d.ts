...
export abstract class BaseCommandInteraction<Cached extends CacheType = CacheType> extends Interaction<Cached> {
  ...
  public editReply(options: InteractionReplyOptions & { fetchReply: true }): Promise<GuildCacheMessage<Cached>>;
  public editReply(options: string | MessagePayload | InteractionReplyOptions): Promise<void>;
